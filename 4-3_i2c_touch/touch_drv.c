...
static int i2c_touch_drv_probe(struct i2c_client *client, const struct i2c_device_id *dt)
{
    ...
    input_set_abs_params(dev->inputdev, ABS_X, 0, 480, 0, 0);
    input_set_abs_params(dev->inputdev, ABS_Y, 0, 272, 0, 0);
    input_set_abs_params(dev->inputdev, ABS_MT_POSITION_X,0, 480, 0, 0);
    input_set_abs_params(dev->inputdev, ABS_MT_POSITION_Y,0, 272, 0, 0);	     
